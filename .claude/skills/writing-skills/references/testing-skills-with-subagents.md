...
**Complete worked example:** See [claude-md-testing-example.md](claude-md-testing-example.md) for a full test campaign testing CLAUDE.md documentation variants.
