# Bug-Report: `dotnet-stryker-netx` (v3.0.24 → v3.1.1 → v3.2.0) — Verlaufs-Dokumentation

**An:** stryker-netx Maintainer-Team
**Von:** Calculator-Testbed-Projekt (.NET 10 / C# 14)
**Datum:** 2026-05-06 (Erstausgabe v3.0.24), 2026-05-06 (Update v3.1.1), 2026-05-06 (Update v3.2.0)
**Status (v3.2.0):** **noch nicht produktionsreif** — Bug #9 (`All`-Profile-Crash) bleibt offen; Bugs #4 und #6 weiterhin offen; alle vorherigen Fixes halten

---

## ⚡ Bug-Status-Verlauf (Übersicht über alle Versionen)

| Bug | v3.0.24 (Initial) | v3.1.1 | v3.2.0 |
|-----|-------------------|--------|--------|
| **#1** Profile-Flag ohne Effekt | 🔴 nicht funktional | ✅ gefixt | ✅ weiterhin gefixt |
| **#2** Banner-Version inkonsistent | 🟡 `1.0.0-preview.1` | ✅ gefixt | ✅ weiterhin gefixt |
| **#3** Falscher Update-Hinweis | 🟡 immer aktiv | ✅ gefixt | ✅ weiterhin gefixt |
| **#4** `--version` braucht Argument | 🟡 | ❌ unverändert | ❌ unverändert |
| **#5** "Could not find a valid analysis"-Warning | 🟡 | ✅ gefixt | ✅ weiterhin gefixt |
| **#6** `--reporters` (plural) unbekannt | 🟡 | ❌ unverändert | ❌ unverändert |
| **#7** NuGet-Publishing-Verzögerung | 🟢 1× beobachtet | n/a | 🟢 wieder beobachtet (vergessener Push lt. Maintainer-Team) |
| **#8** Multi-Source-Project-UX | 🟢 | ❌ unverändert | ❌ unverändert |
| **#9** Crash bei `--mutation-profile All` | — | 🔴 **NEU** | 🔴 **immer noch nicht gefixt** |

**Trendlinie:** Zwischen v3.0.24 und v3.1.1 wurden 4 von 6 testbaren Bugs behoben. Zwischen v3.1.1 und v3.2.0 **kein einziger weiterer Bug**, insbesondere nicht der gravierendste (#9). Welche Verbesserungen v3.2.0 effektiv enthält, ist aus der externen Black-Box-Beobachtung nicht erkennbar — Release-Notes sollten klären, was 3.2.0 von 3.1.1 unterscheidet.
