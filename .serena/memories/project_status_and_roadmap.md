# Status & Roadmap (Stand 2026-06-12, nach Sprint 183 / v3.3.8)
...
| 184 | Backlog-Rest | **IN PROGRESS (Branch feature/184-backlog-rest, gestartet 2026-06-12, letzter Fahrplan-Sprint)**: #287/G-22 (MutantControl.RegisterCoverage:225 lock+List.Contains O(n) je IsActive-Hit → HashSet-Drop-in + BenchmarkDotNet-Delta; G-24 toter ProcessExit-Handler gleich mit), #280/F-01 (InlineConstants+ConstantReplacement melden Mutator.Linq → additiver Enum-Member Number; ignore-mutations[linq] deaktivierte Konstanten still; Type-Assertions fehlen in allen Mutator-Tests), #279-BATCH-1 nach Blaupause NullCoalescing/ArgumentPropagation/MemberVariable (UOI: numerischer GetTypeInfo-Gate + get-only-Prop 20/20-CE; ROR: Ordnungs-Matrix nur numerisch/IComparable, ==/!=-Swaps bleiben 8/8-CE; ConstructorNull: IsReferenceType-Gate F-35; TypeDrivenReturn: Async-Guard CS4016 F-23; Doc-F-30 „classified as killed"→CompileError 3 Dateien; Block/AsSpanAsMemory/F-08-Filter bleiben OFFEN im Epic), H-25 (Threshold-Quervalidierung gegen Effektivwerte statt SuppliedInput), I-11 (Guard statt stillem mutantId=-1 bei MTP-Multi-Mutant). Erfolgsmaß: 56 %-CE-Probe (15-LOC, profile All — Class3-Shapes) rückläufig je Batch; Benchmark-Delta dokumentiert. Ship v3.3.9 |

## Offene Issues (Fix-Backlog)
Offen: #279 (Epic), #280, #287, #302 (P3-Sammelliste, teilabgehakt).
Geschlossen in 179: #273/#274/#282/#283/#292/#294/#295 · 180: #278/#284/#285 · 181: #286 · 182: #277/#288/#297 · 183: #290/#291/#296/#299/#300.
