...
{
    private static readonly TextSpan _textSpanMaxValue = new(0, int.MaxValue);
    ...
    public bool Equals(IFilePattern? other) => other is not null && string.Equals(Glob.ToString(), other.Glob.ToString(), StringComparison.Ordinal) && IsExclude == other.IsExclude && TextSpans.SequenceEqual(other.TextSpans);
