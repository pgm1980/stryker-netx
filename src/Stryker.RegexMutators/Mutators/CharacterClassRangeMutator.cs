...
public sealed class CharacterClassRangeMutator : RegexMutatorBase<CharacterClassRangeNode>, IRegexMutator
{
    ...
    private static bool ValidateStartNode(RegexNode? mutatedStartNode, RegexNode originalEndNode) =>
    ...
    private static bool ValidateEndNode(RegexNode? mutatedEndNode, RegexNode originalStartNode) =>
