...
public class CharacterClassShorthandNegationMutator : RegexMutatorBase<CharacterClassShorthandNode>, IRegexMutator
{
    ...
    private static RegexMutation CharacterClassShorthandNegation(CharacterClassShorthandNode node, RegexNode root)
    {
        var negatedShorthandCharacter = char.IsLower(node.Shorthand)
