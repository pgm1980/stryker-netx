...
public class MutatorDescriptionAttribute : Attribute
{
    ...
    public override bool Equals([NotNullWhen(true)] object? obj) =>
        obj is MutatorDescriptionAttribute other && string.Equals(other.Description, Description, StringComparison.Ordinal);

    public override int GetHashCode() => StringComparer.Ordinal.GetHashCode(Description ?? string.Empty);
