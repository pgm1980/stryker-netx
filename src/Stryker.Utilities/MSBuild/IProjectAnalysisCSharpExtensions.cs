...
public static class IProjectAnalysisCSharpExtensions
{
    ...
    /// </summary>
    public static IEnumerable<string> GetPreprocessorSymbols(this IProjectAnalysis projectAnalysis)
    {
    ...
    /// </summary>
    public static CSharpCompilationOptions GetCompilationOptions(this IProjectAnalysis projectAnalysis)
    {
        ArgumentNullException.ThrowIfNull(projectAnalysis);
    ...
    /// </summary>
    public static CSharpParseOptions GetParseOptions(this IProjectAnalysis projectAnalysis, IStrykerOptions options)
    {
        ArgumentNullException.ThrowIfNull(projectAnalysis);
    ...
    private static NullableContextOptions GetNullableContextOptions(this IProjectAnalysis projectAnalysis)
    {
