...
public static class IAnalyzerResultExtensions
{
    ...
    /// <returns>true if result is complete enough</returns>
    public static bool IsValidFor(this IAnalyzerResult br, string framework) => br.IsValid() && string.Equals(br.TargetFramework, framework, StringComparison.Ordinal);
    ...
    public static int GetWarningLevel(this IAnalyzerResult analyzerResult) =>
        int.Parse(analyzerResult.GetPropertyOrDefault("WarningLevel", "4"), CultureInfo.InvariantCulture);
