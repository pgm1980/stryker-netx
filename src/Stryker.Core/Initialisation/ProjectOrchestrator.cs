...
public sealed class ProjectOrchestrator : IProjectOrchestrator
{
    ...
    private ITestRunner _runner = null!; // initialized in MutateProjects() before any other call
    ...
    private static string ReadProjectName(ModuleDefinition module, string details)
    {
        if (module.Assembly.CustomAttributes
                .FirstOrDefault(e => string.Equals(e.AttributeType.Name, "AssemblyMetadataAttribute", StringComparison.Ordinal)
    ...
    {
        if (module.Assembly.CustomAttributes
                .FirstOrDefault(e => string.Equals(e.AttributeType.Name, "AssemblyInformationalVersionAttribute", StringComparison.Ordinal)
