...
public sealed class JsonMutant : IJsonMutant
{
    ...
    public ILocation Location { get; init; } = null!; // initialized via ctor or object initializer
    ...
    {
        Id = mutant.Id.ToString(CultureInfo.InvariantCulture);
