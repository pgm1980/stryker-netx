...
internal static class RoslynHelper
{
    ...
    /// <returns>A copy of <paramref name="sourceNode"/> with the mutation applied.</returns>
    ...
    /// <param name="skipBlocks">if true, skip child block statements when scanning</param>
