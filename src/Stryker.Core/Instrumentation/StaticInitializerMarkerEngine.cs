...
/// </summary>
internal sealed class StaticInitializerMarkerEngine : BaseEngine<ExpressionSyntax>
{
    ...
    protected override SyntaxNode Revert(ExpressionSyntax node)
    {
        ...
        {
            return parenthesized.ExpressionBody ?? throw new InvalidOperationException($"Can't extract original expression from {node}");
        }
