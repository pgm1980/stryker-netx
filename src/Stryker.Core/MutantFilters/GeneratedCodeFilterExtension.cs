...
public static class GeneratedCodeFilterExtension
{
    ...
    /// <param name="fileSystem">Optional file system abstraction; defaults to a real <see cref="FileSystem"/>.</param>
    /// <returns>
    /// <para><see langword="true"/> if the <see cref="SyntaxNode"/> contained in <paramref name="tree"/> is
    ...
    /// <param name="fileSystem">File system abstraction used to inspect the path.</param>
    /// <returns>
    /// <para><see langword="true"/> if <paramref name="filePath"/> is the name of a generated file; otherwise,
    /// <see langword="false"/>.</para>
    /// </returns>
    /// <seealso cref="IsGenerated(SyntaxTree, IFileSystem)"/>
