...
/// <typeparam name="TBase">Type of the node once mutated. In practice, either <typeparamref name="TNode"/> or a base class of it.</typeparam>
...
internal class NodeSpecificOrchestrator<TNode, TBase> : INodeOrchestrator where TBase : SyntaxNode where TNode : class, TBase
{
    /// <summary>
    ...
    /// <returns>A syntax node (typeof <typeparamref name="TBase"/>) with mutations injected, if possible./></returns>
