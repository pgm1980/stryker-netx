...
/// </summary>
internal sealed class StaticConstructorOrchestrator : BaseMethodDeclarationOrchestrator<ConstructorDeclarationSyntax>
{
    protected override bool CanHandle(ConstructorDeclarationSyntax? t) => t is not null && t.IsStatic();
