...
/// </summary>
internal sealed class MutateAtStatementLevelOrchestrator<T> : NodeSpecificOrchestrator<T, T> where T : SyntaxNode
{
    ...
    /// <inheritdoc />
    protected override bool CanHandle(T? t) => t is not null && _predicate(t);
