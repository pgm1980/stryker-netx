...
internal sealed class ExpressionBodiedPropertyOrchestrator : BaseFunctionOrchestrator<PropertyDeclarationSyntax>
{
    protected override bool CanHandle(PropertyDeclarationSyntax? t) => t is not null && (t.ExpressionBody != null || t.Initializer != null && t.IsStatic());
