...
/// </summary>
internal sealed class StaticFieldDeclarationOrchestrator : MemberDefinitionOrchestrator<FieldDeclarationSyntax>
{
    protected override bool CanHandle(FieldDeclarationSyntax? t) => t is not null && t.IsStatic() && t.Declaration.Variables.Any(v => v.Initializer != null);
