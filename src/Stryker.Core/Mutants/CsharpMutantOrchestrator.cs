...
public partial class CsharpMutantOrchestrator : BaseMutantOrchestrator<SyntaxTree, SemanticModel>
{
    ...
    /// <summary>
    /// Creates a new C# mutant orchestrator.
    /// </summary>
    /// <param name="placer">The mutant placer used to inject mutations.</param>
    /// <param name="mutators">The mutators that should be active during the mutation process.</param>
    /// <param name="options">Optional Stryker options.</param>
    ...
    /// is a duplicate.
    /// </summary>
    private static Mutant CreateNewMutant(Mutation mutation, MutationContext context)
    {
